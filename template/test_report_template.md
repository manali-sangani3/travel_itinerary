...
* For every test case, generate an execution result.
* Do NOT repeat the full test specification.
* Summarize execution in a tabular format.
* Each test case must contain:
  ...
  * Actual Result
  * Status (PASS / FAIL)
* Status must be determined based on whether the actual result matches the expected result.
* Keep Expected Result and Actual Result concise (1-2 lines maximum).
